...
const NotificationsPage = () => {
  ...
  return (
    <div className='p-4 sm:p-6 lg:p-8'>
      <div className='container max-auto max-w-4xl space-y-8 flex justify-center'>
                  ...
                  <div key={request._id} className='card bg-base-200 shadow-sm hover:shadow-md transition-shadow'>
                    <div className='card-body p-4'>
                      <div className='flex items-center justify-between'>
                        ...
                        <button className='btn btn-primary btn-small' onClick={() => acceptRequestMutation(request._id)} disabled={isPending}>
                          Accept
                        </button>
                      </div>
                    </div>
            ...
            <section className='space-y-4'>
              ...
              <div className='space-y-3'>
                {acceptedRequests.map((notifications) => (
                  <div key={notifications._id} className='card bg-base-200 shadow-sm p-4'>
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <p className='text-sm my-1'>{notifications.recipient.fullName} accepted your friend request</p>
